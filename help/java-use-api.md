...
Es gibt zwar verschiedene Möglichkeiten, eine Java-Klasse mit HTL zu integrieren, die einfachste besteht jedoch darin, die `WCMUsePojo` -Klasse. Für unser Beispiel `/apps/my-example/component/info/Info.java`:
